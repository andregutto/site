...
export const ACHIEVEMENT_DEFS: AchievementDef[] = [
  ...
  { key: 'three_million',  name: 'Três Milhões',         description: 'Patrimônio acima de R$ 3.000.000',         xp: 200, gradient: ['#312E81','#6366F1'], ringColor: '#A5B4FC' },
  { key: 'five_million',   name: 'Cinco Milhões',        description: 'Patrimônio acima de R$ 5.000.000',         xp: 300, gradient: ['#134E4A','#0D9488'], ringColor: '#2DD4BF' },
  { key: 'ten_million',    name: 'Dez Milhões',          description: 'Patrimônio acima de R$ 10.000.000',        xp: 500, gradient: ['#4C0519','#F43F5E'], ringColor: '#FB7185' },
