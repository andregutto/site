      ...
      <div style={{ width: '100%', maxWidth: 672, display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        <div style={{ background: '#FFFFFF', borderRadius: 16, padding: '36px 36px', border: '1px solid var(--arvo-border)', boxShadow: '0 1px 4px rgba(13,13,13,0.05)' }}>
          <div style={{ marginBottom: 28 }}>
            <h1 style={{ fontFamily: "'Tenor Sans', sans-serif", fontSize: 28, letterSpacing: '0.06em', color: 'var(--arvo-black)', marginBottom: 8 }}>{p.title}</h1>
            <p style={{ fontFamily: "'Tenor Sans', sans-serif", fontSize: 11, letterSpacing: '0.10em', color: 'var(--arvo-fg-soft)' }}>{p.updated}</p>
          </div>
