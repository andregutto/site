                  ...
                  <div className="bg-[var(--arvo-surface)] rounded-2xl border border-[var(--arvo-border)] shadow-sm p-6">
                    ...
                    <ResponsiveContainer width="100%" height={180}>
                      <BarChart data={feeResult.monthly} margin={{ left: 0, right: 8, top: 4, bottom: 0 }}>
                        ...
                        <XAxis dataKey="month" tickFormatter={shortMonth} tick={{ fontSize: 12, fill: 'var(--arvo-fg-soft)' }} axisLine={false} tickLine={false} />
                        <YAxis tickFormatter={v => (hideValues ? '•••' : fmt(Number(v)).replace(/[^0-9.,kKmM]/g, ''))} tick={{ fontSize: 12, fill: 'var(--arvo-fg-soft)' }} axisLine={false} tickLine={false} width={50} />
                        <Tooltip
